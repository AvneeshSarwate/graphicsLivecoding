...
function* planeLerpGen(ind, duration, direction){
    ...
    while(true){
        ...
        //TODO sliders- gesutre start phase - frac = Math.max(Math.min(1, elapsed/duration - ind*sliders[4]), 0)
        ...
        let newTime = getTime()
        elapsed += (newTime - lastFrameTime) * (1-sliders[1]) * 4 ; //TODO-slider - put one here for gesture time (and preset slider js array val to start at "1")
